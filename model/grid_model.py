...
class HybridGridModel(parl.Model):
    def __init__(self, obs_dim, con_action_dim, dis_action_dim, flags):
        ...
        self.actor_head = HybridActorModel(256, con_action_dim, dis_action_dim, flags)
        self.critic_head = HybridCriticModel(obs_dim, con_action_dim, dis_action_dim, flags)
...
class HybridActorModel(parl.Model):
    def __init__(self, obs_dim, con_action_dim, dis_action_dim, flags):
